...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { active: @slot.active, end_hour: @slot.end_hour, end_min: @slot.end_min, start_hour: @slot.start_hour, start_min: @slot.start_min, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { active: @slot.active, end_hour: @slot.end_hour, end_min: @slot.end_min, start_hour: @slot.start_hour, start_min: @slot.start_min, user_id: @slot.user_id } }
